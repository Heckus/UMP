...
\begin{itemize}
    \item \textbf{Pipeline Integration:} Implement the GS-DIFF (or similar primitive-space) change detection pipeline on top of the trained underwater 3DGS models.
